...
- Navigation interactive : **Analytics**, **Contenu**, **Commentaires** et **Extraction** sont des dépliants fermés au chargement. Analytics et Commentaires se déclinent par plateforme ; Contenu regroupe la file **Publication**, la vue globale et les quatre réseaux ; Extraction expose ses modules éditoriaux.
