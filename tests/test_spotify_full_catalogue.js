...
assert.match(dashboard, /tracks:normalized\.flatMap\(source=>source\.tracks\)/);
assert.doesNotMatch(dashboard, /catalogues\.flatMap\(source=>Array\.isArray\(source\.tracks\)\?source\.tracks:\[\]\)/);
