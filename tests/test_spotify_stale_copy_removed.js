...
if(!index.includes('dashboard.js?v=20260724-playlist-cover-source-v1'))throw new Error('Dashboard cache version is stale');
if(!index.includes('coverage.js?v=20260724-counter-tooltip-cleanup-v1'))throw new Error('Coverage cache version is stale');
