...
if(!index.includes('dashboard.js?v=20260728-selection-no-self-release-v1'))throw new Error('Dashboard cache version is stale');
if(!index.includes('coverage.js?v=20260725-nav-counter-hover-v2'))throw new Error('Coverage cache version is stale');
