...
for(const forbidden of ['Scan incomplet, pause s̩curit̩ Spotify','Scan incomplete, Spotify safety pause'])
...
if(!index.includes('dashboard.js?v=20260801-track-floor-100k-v1'))throw new Error('Dashboard cache version is stale');
if(!index.includes('coverage.js?v=20260801-track-floor-100k-v1'))throw new Error('Coverage cache version is stale');
