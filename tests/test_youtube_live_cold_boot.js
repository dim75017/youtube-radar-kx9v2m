...
assert.match(index, /dashboard-02-helpers\.js\?v=20260813-live-discovery-v1/,
  'the helper asset cache key changes with official live discovery');
assert.match(index, /dashboard-04-recommendations\.js\?v=20260813-live-discovery-v1/,
