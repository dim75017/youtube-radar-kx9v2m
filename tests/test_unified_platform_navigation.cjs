  ...
  const surfaces = [
    {
      ...
      hrefs: ["./", "spotify/?app=20260825-toolbar-v1#opportunities", "social/"],
    },
    {
      source: read("spotify/index.html"),
      hrefs: ["../", "./?app=20260825-toolbar-v1#opportunities", "../social/"],
    },
    {
      source: read("social-app/app/SocialOS.tsx"),
      hrefs: ["../", "../spotify/?app=20260825-toolbar-v1#opportunities", "./"],
    },
  ];
...
test("every platform prerenders both destinations for instant switching", () => {
  ...
  assert.match(youtube, /"urls":\["spotify\/\?app=20260825-toolbar-v1#opportunities","social\/"\]/);
  assert.match(spotify, /"urls":\["\.\.\/","\.\.\/social\/"\]/);
  assert.match(socials, /"urls":\["\/youtube-radar-kx9v2m\/","\/youtube-radar-kx9v2m\/spotify\/\?app=20260825-toolbar-v1#opportunities"\]/);
