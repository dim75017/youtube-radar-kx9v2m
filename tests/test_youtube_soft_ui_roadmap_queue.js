...
assert.match(index, /dashboard\.css\?v=20260728-recommendations-continuous-v3/, 'stylesheet cache version is renewed');
assert.match(index, /dashboard-04-recommendations\.js\?v=20260728-recommendations-continuous-v3/, 'roadmap script cache version is renewed');
